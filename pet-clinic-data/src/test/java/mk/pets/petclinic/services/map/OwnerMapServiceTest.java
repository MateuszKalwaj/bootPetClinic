...
class OwnerMapServiceTest {
    ...
    @Test
    void findByLastName() {
        Owner pink = ownerMapService.findByLastName(lastName);
        assertNotNull(pink);
        assertEquals(ownerId, pink.getId());
    }

    @Test
    void findByLastNameNotFound() {
        Owner pink = ownerMapService.findByLastName("noLastName");
        assertNull(pink);
       // assertEquals(ownerId, pink.getId());
    }
}